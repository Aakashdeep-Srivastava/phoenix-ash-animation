...
import { ArrowRight, Package, Recycle } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="font-inter text-muted-foreground max-w-2xl mx-auto">
            Discover our transformative sustainable solutions designed to overcome challenges and elevate your business while promoting environmental responsibility.
          </p>
        </div>

        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* MVP Card 1 - Asset Management */}
          <div 
          ...
          >
            <div className="p-6 md:p-8 bg-[#11172E]/40 backdrop-blur-md border border-horizon-light/10">
              <div className="w-12 h-12 bg-horizon-dark/50 rounded-lg flex items-center justify-center mb-6 magical-glow">
                <Package className="text-horizon-light" size={24} />
              </div>
              ...
              <p className="font-inter text-muted-foreground mb-6">
                Our sustainable asset management solution helps businesses track, manage, and optimize resource usage with the power of phoenix transformation.
              </p>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-sm">Magical asset tracking dashboard</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 bg-horizon-dark/70 rounded-full flex items-center justify-center mr-3 mt-1">
                    <div className="w-2 h-2 bg-horizon-light rounded-full"></div>
                  </div>
                  <span className="text-sm">Phoenix-powered lifecycle management</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 bg-horizon-dark/70 rounded-full flex items-center justify-center mr-3 mt-1">
                    <div className="w-2 h-2 bg-horizon-light rounded-full"></div>
                  </div>
                  <span className="text-sm">Sustainable resource optimization</span>
                </li>
              </ul>
          ...
          >
            <div className="p-6 md:p-8 bg-[#11172E]/40 backdrop-blur-md border border-ember-light/10">
              ...
              <h3 className="font-cormorant text-2xl font-semibold mb-3 text-ember-light">
                Rapid Waste Management
              </h3>
              
              <p className="font-inter text-muted-foreground mb-6">
                Transform your waste management processes with our phoenix rebirth framework, designed to eliminate environmental impact and continuously renew resources.
              </p>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start">
                  ...
                  <span className="text-sm">Eco-friendly disposal enchantments</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 bg-ember-dark/70 rounded-full flex items-center justify-center mr-3 mt-1">
                    <div className="w-2 h-2 bg-ember-light rounded-full"></div>
                  </div>
                  <span className="text-sm">Magical material recovery transformations</span>
                </li>
                <li className="flex items-start">
                  <div className="flex-shrink-0 w-5 h-5 bg-ember-dark/70 rounded-full flex items-center justify-center mr-3 mt-1">
                    <div className="w-2 h-2 bg-ember-light rounded-full"></div>
                  </div>
                  <span className="text-sm">Phoenix flame-powered recycling systems</span>
                </li>
              </ul>
